...
def home(request):
    ...
    return render(request, 'customer_order/index.html')
...
def register(request):
    ...
    return render(request, 'customer_order/register.html', context=context)
...
def my_login(request):
    ...
    return render(request, 'customer_order/my-login.html', context=context)
...
def create_record(request):
    ...
    return render(request, 'customer_order/create-record.html', context=context)
...
def update_record(request, pk):
    ...
    return render(request, 'customer_order/update-record.html', context=context)
